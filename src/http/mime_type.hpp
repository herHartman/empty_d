...
private:
  std::string type_;
  std::string subtype_;
  boost::optional<std::string> charset_;
  std::unordered_map<std::string, std::string> parameters_;
};

class PredefinedMimeTypes {
  ...
  static inline const MimeType kApplicationRSSXML{
      MimeType::kApplicationTypeValue, MimeType::kRSSXMLValue};

  static inline const MimeType kApplcationNDJSON{
      MimeType::kApplicationTypeValue, MimeType::kNDJSONValue};
  ...
  static inline const MimeType kMultipartFormMixed{
      MimeType::kMultipartTypeValue, MimeType::kFormMixedValue};
